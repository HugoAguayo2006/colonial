...
export default function App() {
  ...
  // 🎯 decide animación por ruta
  const getVariants = (path) => {
    if (path.startsWith("/niveles")) return variantsFadeUp;   // kinder: desde abajo
    if (path.startsWith("/niveles/preescolar")) return variantsUp;   // kinder: desde abajo
    if (path.startsWith("/niveles/secundaria")) return variantsRight; // secundaria: lateral
    ...
    return variantsFade; // default: fade
  };
